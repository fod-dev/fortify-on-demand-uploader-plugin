...
public class ScanStatusPoller {
    ...
    public void printScanSummary(ScanSummaryDTO scanSummaryDTO) {
        if (scanSummaryDTO == null) {
            ...
            logger.println(String.format("Assessment Type Name: %s", scanSummaryDTO.getAssessmentTypeName()));
            logger.println(String.format("Entitlement Id: %s", scanSummaryDTO.getEntitlementId()));
